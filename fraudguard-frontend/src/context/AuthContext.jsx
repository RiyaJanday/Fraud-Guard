...
import { fraudApi, getAccessToken, getRefreshToken, setTokens, clearTokens } from '../lib/api'
...
export function AuthProvider({ children }) {
  ...
  // On mount, verify the cached token is still actually valid against the
  // backend (rather than just trusting localStorage) — a token could have
  // expired, been revoked, or the user could've been deactivated elsewhere.
  useEffect(() => {
